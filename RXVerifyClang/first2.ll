...
@"OBJC_CLASSLIST_REFERENCES_$_.4" = private global %struct._class_t* @"OBJC_CLASS_$_RXAAAA", section "__DATA,__objc_classrefs,regular,no_dead_strip", align 8
@OBJC_SELECTOR_REFERENCES_.5 = private externally_initialized global i8* getelementptr inbounds ([6 x i8], [6 x i8]* @OBJC_METH_VAR_NAME_.3, i64 0, i64 0), section "__DATA,__objc_selrefs,literal_pointers,no_dead_strip", align 8
...
define i32 @main1(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  %3 = load i8*, i8** bitcast (%struct._class_t** @"OBJC_CLASSLIST_REFERENCES_$_.4" to i8**), align 8
...
define i32 @main2(i32, i8** nocapture readnone) local_unnamed_addr #0 personality i8* bitcast (i32 (...)* @__objc_personality_v0 to i8*) {
  ...
  %5 = load i8*, i8** bitcast (%struct._class_t** @"OBJC_CLASSLIST_REFERENCES_$_.4" to i8**), align 8
