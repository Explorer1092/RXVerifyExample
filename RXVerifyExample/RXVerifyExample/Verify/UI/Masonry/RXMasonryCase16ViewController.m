//
//  RXMasonryCase16ViewController.m
//  RXVerifyExample
//
...
#import "RXMasonryCase16ViewController.h"
#import <Masonry/Masonry.h>

@interface RXMasonryCase16ViewController ()
...
@implementation RXMasonryCase16ViewController
...
- (void)viewDidLoad {
    ...
    UIView *attachmentView = [self generateNewAttachmentLabelWithContent:@"Attachemnt Attachemnt Attachemnt"];
    [_containerView addSubview:attachmentView];
    
    [attachmentView mas_makeConstraints:^(MASConstraintMaker *make) {
        // 依附在tipLabel上
        make.left.lessThanOrEqualTo(_tipLabel.mas_left).with.offset(0).priorityHigh();
        make.bottom.equalTo(_tipLabel.mas_top).with.offset(0).priorityHigh();
